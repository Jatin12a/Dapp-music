...
import { PlaylistCard1, PlaylistCard2, PlaylistCard3, Heart } from "../SVG/index";

const PlaylistCard = ({ post }) => (
  <div className="relative flex min-w-0 items-center truncate rounded-md bg-white py-2 text-neutral600 hover:bg-neutral50 lt:px-2">
    <div className="group relative mr-2 h-12 w-12 flex-shrink-0 overflow-hidden rounded-md">
      ...
      >
        <div className="c-hYjZQi play-button-container" tabIndex={0}>
          <div className="c-cFovLR" style={{ marginLeft: 0 }}>
            <PlaylistCard1 />
          </div>
          <PlaylistCard2 />
        </div>
